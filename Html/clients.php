        ...
        <table class="table border=1">
          ...
          while ($row = $result->fetch()) : ?>
            <tr>
              <form action="includes/client.inc.php" method="REQUEST">
                ...
                <td>
                  <div class="form-group">
                    <button class="btn btn-info" name="edit" value="<?php echo $row['idClient']; ?>" type="submit">Edit</button>
                    <button class="btn btn-danger" name="delete" value="<?php echo $row['idClient']; ?>" type="submit">Delete</button>
                  </div>
                </td>
            </tr>
            </form>
          ...
          <tr>
            <form action="includes/client.inc.php" method="REQUEST">
              <div class="form-group">
                <td>
                  <input type="text" name="newSocialName" class="form-control" placeholder="New Client">
              </div>
              </td>
              <div class="form-group">
